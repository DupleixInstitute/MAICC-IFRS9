...
<div class="sm:flex sm:items-center sm:ml-6" v-if="can('settings')">
                        <jet-dropdown align="right" width="48">
                            <template #trigger>
                                <a href="#" type="button"
                                   class="h-full inline-flex items-center px-1 pt-1 border-b-2 border-transparent text-sm font-medium leading-5 text-gray-500 hover:text-gray-700 hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300 transition duration-150 ease-in-out">
                            ...
                            <template #content>
                                <jet-dropdown-link :href="route('stageing-rules.index')">
                                    Quantitative Thresholds
                                </jet-dropdown-link>
                                <jet-dropdown-link :href="route('sicr-groups.index')">
                                    SICR Groups Setup
                                </jet-dropdown-link>
                                <jet-dropdown-link :href="route('sicr-items.index')">
                                    SICR Alert Items
                                </jet-dropdown-link>
                                <jet-dropdown-link :href="route('sicr-triggers.index')">
                                    SICR Trigger Alerts
                                </jet-dropdown-link>
                            </template>
                        </jet-dropdown>
