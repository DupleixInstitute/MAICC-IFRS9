    ...
    <app-layout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                <inertia-link class="text-maiic-500 hover:text-maiic-600" :href="route('loan_approval_stages.index')">
                    Approval Stages
                </inertia-link>
...
export default {
    ...
    data() {
        return {
            form: this.$inertia.form({
                ...
                stage_position: this.stage.stage_position,
    ...
    methods: {
        submit() {
            this.form.put(this.route('loan_approval_stages.update',this.stage.id), {})
