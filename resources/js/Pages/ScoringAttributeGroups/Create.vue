                    ...
                    <div class="grid grid-cols-1 gap-2">
                        ...
                        <div class="mt-4">
                            ...
                            <div class="relative">
                                ...
                                <jet-input
                                    type="text"
                                    class="mt-1 block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md leading-5 bg-white placeholder-gray-500 focus:outline-none focus:placeholder-gray-400 focus:ring-1 focus:ring-maiic-500 focus:border-maiic-500 sm:text-sm mb-2"
                                    v-model="tableSearch"
