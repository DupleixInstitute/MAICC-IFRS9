    ...
    <app-layout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                <inertia-link class="text-maiic-500 hover:text-maiic-600" :href="route('locations.regions.index')">
                    Regions
                </inertia-link>
                <span class="text-maiic-500 font-medium">/</span> Region #{{ province.id }}
            </h2>
        </template>
