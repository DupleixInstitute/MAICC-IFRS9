    ...
    <app-layout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                <inertia-link class="text-maiic-500 hover:text-maiic-600" :href="route('locations.regions.index')">Regions
                </inertia-link>
...
export default {
    ...
    data() {
        return {
            ...
            pageDescription: "Create Region",
        }

    },
    methods: {
        submit() {
            this.form.put(this.route('locations.regions.update',this.province.id), {})
