    ...
    <app-layout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                <inertia-link class="text-maiic-500 hover:text-maiic-600" :href="route('locations.provinces.index')">Provinces
                </inertia-link>
...
export default {
    ...
    data() {
        return {
            ...
            pageDescription: "Create Province",
        }

    },
    methods: {
        submit() {
            this.form.put(this.route('locations.provinces.update',this.province.id), {})
