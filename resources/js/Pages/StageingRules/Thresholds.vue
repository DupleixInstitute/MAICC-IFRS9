        ...
        <div class="max-w-4xl mx-auto space-y-6">
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                <div class="bg-gradient-to-r from-gray-800 to-gray-600 px-6 py-4">
                    ...
                    <p class="mt-1 text-maiic-100 text-sm">Set quantitative rules for loan staging based on delinquency periods</p>
                </div>
                ...
                <form @submit.prevent="save" class="p-6 space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <!-- Stage 1 Threshold -->
                        <div class="bg-maiic-50 border border-maiic-200 rounded-lg p-4 transition-all hover:shadow-md">
                            <div class="flex items-center mb-3">
                                <div class="w-8 h-8 bg-maiic-500 rounded-full flex items-center justify-center text-white font-bold text-sm mr-3">
                                    1
                                </div>
                                <div>
                                    <jet-label class="text-maiic-900 font-semibold">
                                        Stage 1 Threshold
                                    </jet-label>
                                    <p class="text-xs text-maiic-700">12-month ECL (Performing loans)</p>
                                </div>
                            </div>
                            <div class="relative">
                                <input 
                                ...
                                <div class="absolute inset-y-0 right-0 pr-4 flex items-center pointer-events-none">
                                    <span class="text-maiic-600 text-sm font-medium">days</span>
                                </div>
                            </div>
                            <p class="text-xs text-maiic-600 mt-2">Loans with ≤ {{ form.stage_1_threshold || 30 }} days past due</p>
                        </div>
                    ...
                    <div class="flex justify-end pt-4 border-t border-gray-200">
                        <button
                            ...
                            class="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-white bg-gradient-to-r from-maiic-700 to-maiic-500 hover:from-maiic-500 hover:to-maiic-00 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-maiic-500 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200"
                        >
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200">
                <div class="px-6 py-4 border-b border-gray-200">
                    <h3 class="text-lg font-semibold text-gray-900 flex items-center">
                        <svg class="w-5 h-5 mr-2 text-maiic-500" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div class="bg-maiic-50 rounded-lg p-4 border border-maiic-200">
                            <h4 class="font-semibold text-maiic-900 mb-2">Stage 1</h4>
                            <p class="text-sm text-maiic-700">12-month expected credit losses for financial instruments that have not had a significant increase in credit risk since initial recognition.</p>
                        </div>
