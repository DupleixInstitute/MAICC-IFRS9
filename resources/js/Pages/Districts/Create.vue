    ...
    <app-layout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                <inertia-link class="text-maiic-500 hover:text-maiic-600" :href="route('locations.districts.index')">Districts
                </inertia-link>
...
export default {
    ...
    methods: {
        submit() {
            this.form.post(this.route('locations.districts.store'), {})
