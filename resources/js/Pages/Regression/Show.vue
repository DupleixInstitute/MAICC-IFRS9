              ...
              <div class="p-6">
                ...
                <div class="mt-6 space-y-3">
                  ...
                  <button
                    ...
                    @click="approveModel"
                    class="w-full inline-flex justify-center items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-maiic-600 hover:bg-maiic-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-maiic-500"
                  >
                    Approve Model
                  </button>
                </div>
              ...
              <div class="p-6">
                <div class="space-y-3">
                  <inertia-link
                    ...
                    class="w-full inline-flex justify-center items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-maiic-500"
                  >
                    Make Predictions
                  </inertia-link>
