          ...
          <form @submit.prevent="submit" class="p-6">
            ...
            <div class="space-y-6">
              ...
              <div>
                ...
                <div v-if="form.indep_vars.length > 0" class="mt-4 p-4 bg-maiic-50 rounded-lg">
                  <div class="flex items-center">
                    <svg class="w-5 h-5 text-maiic-400 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div class="flex justify-end space-x-3 pt-6 border-t">
                ...
                <button
                  ...
                  class="inline-flex items-center px-4 py-2 bg-maiic-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-maiic-700 focus:outline-none focus:border-maiic-700 focus:ring focus:ring-maiic-200 active:bg-maiic-800 transition disabled:opacity-25"
                >
