...
const downloadReport = () => {
    window.open(route('reports.loan-book-export', { ...form, export: 1 }), '_blank');
};
</script>

<template>
    <Head title="Loan Book Export" />

    <AppLayout>
        <template #header>
            <div class="flex items-center justify-between">
                <h2 class="font-semibold text-xl text-gray-800 leading-tight">Loan Book Export Report</h2>
