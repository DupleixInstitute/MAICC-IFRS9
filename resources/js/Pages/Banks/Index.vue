<template>
    <app-layout>
        ...
        <div class=" mx-auto mb-4 flex justify-between items-center">
            ...
            <inertia-link v-if="can('banks.create')" class="btn btn-blue" :href="route('banks.create')">
                <span>Create </span>
            ...
            <div class="maiic-panel maiic-table-wrap">
                <table class="maiic-table">
                    ...
                    <tr v-if="banks.data.length === 0">
                        <td class="border-t px-6 py-4 text-center" colspan="3">No banks found.</td>
                    </tr>
                    </tbody>
                </table>
...
export default {
    ...
    watch: {
        form: {
            handler: _.debounce(function () {
                ...
                this.$inertia.get(this.route('banks.index', Object.keys(query).length ? query : {}))
            }, 500),
            deep: true,
        },
    },
    methods: {
        ...
        destroy() {
            ...
            this.$inertia.delete(this.route('banks.destroy', this.selectedRecord))
