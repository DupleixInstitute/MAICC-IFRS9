  ...
  <div class="p-6">
    ...
    <form @submit.prevent="submit" class="space-y-4">
      <div>
          ...
          <select v-model="form.profile_id" class="mt-1 block w-full border-gray-300 focus:border-maiic-300 focus:ring focus:ring-maiic-200 focus:ring-opacity-50 rounded-md shadow-sm">
      ...
      <div class="flex justify-end space-x-2 mt-6">
        ...
        <button type="submit" class="px-4 py-2 bg-maiic-600 text-white rounded hover:bg-maiic-700">Save</button>
      </div>
    </form>
  </div>
</template>
