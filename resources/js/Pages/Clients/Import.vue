...
1002,0774892763-Jane Smith</pre>
                        ...
                        <div class="mt-4">
                            ...
                            <ul class="mt-2 text-sm text-gray-600 list-disc list-inside">
                                ...
                                <li>Public Name column should have phone number first, followed by a dash (-), then the
                                    name
                                </li>
                        ...
                        <div class="mt-4">
                            <jet-button type="button" @click="downloadSample" class="w-full justify-center">
...
export default {
    ...
    methods: {
        submit() {
            this.form.post(route('clients.import.store'), {
                onProgress: (progress) => {
                    if (progress.total) {
