            ...
            <div class="md:flex md:items-start">
                ...
                <div class="w-full md:w-9/12 p-4 md:ml-4 bg-white sm:mt-4">
                    <div class="flex justify-between ">
                        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Create Shareholder</h2>
...
export default {
    ...
    data() {
        return {
            form: this.$inertia.form({
                ...
                itc_ref_no: null,
                itc_ref_date: null,
                number_of_paid_debts: null,
                number_of_defaulted_debts: null,
                number_of_judgements: null,
                number_of_trace_alerts: null,
                blacklisted: null,
                fraud_alert: null,
            }),
            pageTitle: "Create Client Shareholder",
            pageDescription: "Create Client Shareholder",
    ...
    methods: {
        submit() {
            this.form.post(this.route('clients.shareholders.store', this.client.id), {})
        },
    },
}
</script>
