...
What the branch still does not do is anything specific to a **floating reset**, a **moratorium of the "Principle Only" kind**, a **restructure**, or **partial disbursements**; and it accrues interest on a convention that is not E-Banker's. Those are the subjects of the phases that follow.
