...
| [TB] | Mapping TBs August 2026 to Audited Financial Statements, received 24 Sep 2026 | `2. Documents from clients\New Doc Received 21 Sep\`; read up in `TB_to_AFS_what_it_tells_us_2026-09-24.pdf` |
...
| F17 | **The trial balance now maps to the audited accounts** [TB]. The tie is asserted on the **category totals** in column F, with column K flagging each row as included; all 142 balance sheet rows read "Tied to AFS". An individual ledger account is the make-up behind an audited figure, never an audited figure itself. | The reconciliation in 7.8 bridges to a category, not to a single account. Quoting one account as an audited number would be wrong |
| F18 | **The fee accounts in the ledger are gross of the reclassification journal.** The EIR-related part of fee income is moved into Interest on term loans at audit time, so a ledger fee figure reads higher than the published fee line, and the two reconcile only when interest income and loan-related income are taken together. | The **ledger** figure is the correct EIR input, because it is the fee as charged to the borrower. The published fee line is after the journal and would understate it |
| F19 | **Scope, in figures** [TB]. Interest the engine recalculates: 1,438,630,092 for 2024, 5,648,900,322 for 2025 and 4,795,224,000 for January to August 2026. Of the 2024 figure, 1,127,466,814 is MAIIC, FinES and staff term loans and 311,163,278 is Mega Farms. Money market, treasury and coupon income, 8,020,041,440 in 2024, is already earned at its own effective rate and is out of scope. | Any EIR adjustment is bounded by the loan book, not by the 9,458,671,532 on the face of the accounts. Worth stating to the auditors early |
...
| O22 | **Is Mega Farms in scope?** Those facilities are 49 percent of 2025 loan interest (2,787,930,845 of 5,648,900,322), sit on their own ledger series (balance sheet 1054 to 1067, income 4214 to 4219, apart from term loans at 1050), and carry a very large expected credit loss at 1066. A credit-impaired loan accrues on the net carrying amount under IFRS 9 5.4.1(b), not the gross. | (a) In scope, with their stage and the basis of the interest already recognised confirmed first; (b) out of scope and disclosed | Dr Thom | The stage of those facilities and how their interest has been recognised |
| O23 | **What drove the 2024 arrangement fee?** The ledger carries 1,337,574,206 for 2024 against 52,025,792 for 2025, and in 2024 that is close to double the interest earned on the term loans. Fees of one to four percent of an approved amount do not usually produce that shape. | (a) Mega Farms facilities written that year explain it; (b) something in 4873 is not an arrangement fee; (c) it spans more than one year | Tamanda | The answer decides how much of 2024 belongs in the EIR |
...
| T9 EIR revenue by year | The engine states EIR revenue for 2024, 2025 and 2026, reconciled to the ledger and to the audited accounts, and shows the difference against what was recognised. The comparison is against the loan book only: 1,438,630,092 for 2024, 5,648,900,322 for 2025 and 4,795,224,000 to August 2026 [TB], not against the whole EIR line. The reconciliation bridges to a category total, since that is where the accounts tie (F17) | Blocked on the fee file, on the amount moved by the reclassification journal in each year, and on Extract C at full coverage |
